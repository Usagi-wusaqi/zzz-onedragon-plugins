...
class FadingSignalOperation(ZOperation):
    ...
    @operation_node(name='前往商城')
    def go_store(self) -> OperationRoundResult:
        """前往商城"""
    ...
    def calculate_max_quantity(self) -> OperationRoundResult:
        ...
        self._max_quantity = int(digit / 50)
    ...
    @node_from(from_name='计算最大获取数量', status='信号残响不足')
